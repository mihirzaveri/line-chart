...
/*
 * $Id: common.js 132065 2013-09-20 22:40:41Z gopi_borra $
...
NYTD.updateNavigation = function( pattern ,replacement) {
    ...
    NYTD.jQuery(document).ready( function(jQuery) {
        ...
        var globalSubsection = jQuery('#subNav_international a');
        if (globalSubsection.length > 0) {
            var subNavGlobalUrl = globalSubsection.attr('href').replace(/(\/international)?\/index.html/, '/international/index.html');
            jQuery('#subNav_international a').attr('href', subNavGlobalUrl);
        }
    });
};
    ...
    var getEditionToggleURL = function (isGlobalEdition) {
        ...
        if (isSectionFrontPage && hasGlobalEditionOfPage) {
            if (isGlobalEdition) {
                ...
                if (currentURL.indexOf("international") == -1) {
